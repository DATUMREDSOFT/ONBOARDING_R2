...
BEGIN
    ...
    -- modificaciÃ³n, con el objetivo de evitar casos como 
    ...
    INSERT INTO cpsad.cs_actualiza_datos (
            ...
            INSERT INTO cpsad.cs_actualiza_datos (
                        ...
                        fecha_actualizacion,
                        tipo_documento_ad,
                      --  nit, JMENJIVAR 123423 Error al actualizar estado_afiiado a FCD en tabla cs_actualiza_datos NIT NO VALIDO
                        num_id,
                        fecha_nacimiento_ad,
                        nup,
                        cod_empresa,
                        ...
                        SYSDATE,
                        :old.tipo_id,
                        --:old.num_id, JMENJIVAR 123423 Error al actualizar estado_afiiado a FCD en tabla cs_actualiza_datos NIT NO VALIDO
                        :old.num_id,
                        :old.fecha_nacimiento,
                        :old.nup,
                        1,
